...
public class PlayerManagerOld {
    ...
    public PlayerManagerOld(BulletAppState bulletAppState, Node rootNode, Camera cam, CameraManager cameraManager, InputHandler inputHandler, PlayerInteractionManager interactionManager, AppSettings settings) {
