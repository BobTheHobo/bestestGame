...
public class InputHandler {
    ...
    public InputHandler(Application app, CrosshairManager crosshairManager, PlayerInteractionManager interactionManager, GameShadows shadows, UIManager ui, CameraManager cameraManager) {
