...
public class GameInputHandler {
    ...
    public GameInputHandler(Application app, CrosshairManager crosshairManager, PlayerInteractionManager interactionManager, InputManager inputManager) {
	...
	String[] mappings = {MAPPING_FORWARD, MAPPING_LEFT, MAPPING_BACK, MAPPING_RIGHT, MAPPING_LEFT_CLICK, MAPPING_RESET, MAPPING_CROSSHAIR};
